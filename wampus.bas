...
170 REM- SET UP FIXED LOCATIONS FOR L ARRAY ITEMS
180 REM- 1-YOU,2-WUMPUS,3&4-PITS,5&6-BATS
190 DIM L(6),M(6)
200 L(1) = 1  : REM YOU START IN ROOM 1
210 L(2) = 7  : REM WUMPUS STARTS IN ROOM 7
220 L(3) = 3  : REM PIT 1 IN ROOM 3
230 L(4) = 15 : REM PIT 2 IN ROOM 15
240 L(5) = 10 : REM BAT 1 IN ROOM 10
250 L(6) = 18 : REM BAT 2 IN ROOM 18
260 FOR J=1 TO 6
270 M(J)=L(J)
280 NEXT J
290 REM- SET# ARROWS
300 A=5
310 L=L(1)
320 REM- RUN THE GAME
330 PRINT "HUNT THE WUMPUS"
340 REM- HAZARD WARNING & LOCATIONS
350 GOSUB 2000
...
3190 L=S(L,2) : REM FIXED MOVE TO SECOND TUNNEL
3200 GOTO 3300
3210 NEXT K
3220 PRINT "MISSED"
3225 L=L(1)
...
3380 L(2)=S(L(2),1) : REM FIXED MOVE TO FIRST TUNNEL
3390 RETURN
...
4290 L=5 : REM FIXED MOVE TO ROOM 5
4300 GOTO 4130
4310 RETURN
5000 END
